        ...
        if($(this).valid()){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    contactorgan: $('#contact_organ').val(),
                    contactjob: $('#contact_job').val(),
                    contacthello: $('#contact_hello').val(),
                ...
                success: function() {
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-envelope-open"></i>Well done!<br>You are now registered for the convening. Please book your hotel below.');
					$('#modalMessage').modal('show');
                },
                error: function() {
                    $('#contact_submit').button('reset');
